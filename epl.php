...
<div id="container">
	...
	<div class="content">
		<?php
			$sql = "SELECT * FROM post WHERE sub_category = 'epl' ORDER BY id DESC";
			...
			if (mysql_num_rows($result) != 0) 
			{
				while ($row = mysql_fetch_array($result)) 
				{
					...
					echo "<span><a href='http://www.facebook.com' target='_blank'><img width='30px' height='30px' src='images/fb.png' /></a><a href='http://www.twitter.com' target='_blank'><img width='30px' height='30px' src='images/twitter.png' /></a><a href='http://www.plus.google.com' target='_blank'><img width='30px' height='30px' src='images/google+.png' /><a href='http://www.instagram.com' target='_blank'><img width='30px' height='30px' src='images/instagram.png' /></a></a></span>";
					echo "</div>";
				}
			}
			else
